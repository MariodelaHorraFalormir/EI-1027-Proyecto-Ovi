...
INSERT INTO persona (id, mail, nombre, apellido_1, apellido_2, telefono, fecha_alta, fecha_baja, fecha_nacimiento, sexo)
OVERRIDING SYSTEM VALUE
VALUES
(1, 'admin1@ovi.es', 'Ana', 'Martinez', 'Lopez', '600111111', '2026-01-01', NULL, '1990-05-10', 'Mujer'),
(2, 'admin2@ovi.es', 'Pablo', 'Ortega', 'Vidal', '600111112', '2026-01-02', NULL, '1988-08-21', 'Hombre'),

(3, 'mario.user@ovi.es', 'Mario', 'De la Horra', 'Gomez', '600222222', '2026-01-05', NULL, '2002-03-14', 'Hombre'),
(4, 'laura.user@ovi.es', 'Laura', 'Navarro', 'Sanchez', '600333333', '2026-01-08', NULL, '2001-07-22', 'Mujer'),
(5, 'joel.user@ovi.es', 'Joel', 'Gil', NULL, '600333334', '2026-01-10', NULL, '2000-11-02', 'Hombre'),

(6, 'carlos.patpati@ovi.es', 'Carlos', 'Ruiz', 'Perez', '600444444', '2026-01-03', NULL, '1995-09-18', 'Hombre'),
(7, 'lucia.patpati@ovi.es', 'Lucia', 'Fernandez', 'Diaz', '600555555', '2026-01-06', NULL, '1997-12-01', 'Mujer'),
(8, 'sofia.patpati@ovi.es', 'Sofia', 'Moreno', 'Gil', '600666666', '2026-01-09', NULL, '1999-04-27', 'Mujer'),
(9, 'alex.patpati@ovi.es', 'Alex', 'Torres', NULL, '600666667', '2026-01-11', NULL, '1998-02-13', 'Otro');
...
OVERRIDING SYSTEM VALUE
VALUES
(1, 'Pendiente', '2026-02-01', NULL, 3),
(2, 'Aceptada', '2026-02-03', '2026-02-05', 3),
(3, 'Rechazada', '2026-02-04', '2026-02-06', 4),
(4, 'Aceptada', '2026-02-10', '2026-02-12', 4),
(5, 'Pendiente', '2026-02-14', NULL, 5),
(6, 'Aceptada', '2026-02-15', '2026-02-16', 5);


-- =========================================
-- CONTRATO
-- Solo para requests aceptadas
-- pa_request y url_documento son UNIQUE
-- =========================================
...
OVERRIDING SYSTEM VALUE
VALUES
(1, 1, 3, 'Hola, me gustaria saber si tienes disponibilidad esta semana.', '2026-02-01 10:15:00'),
...
(4, 2, 9, 'Genial, podemos concretar los detalles por aqui.', '2026-02-05 09:05:00'),
(5, 2, 3, 'De acuerdo, revisare el contrato hoy mismo.', '2026-02-05 09:10:00'),

(6, 3, 4, 'Hola, queria consultar el estado de mi solicitud.', '2026-02-04 12:00:00'),
